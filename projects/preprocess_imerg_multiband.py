...
if __name__ == "__main__":
    ...
    columns={config['imerg_multiband']['columns']}
    source_path={config['imerg_multiband']['source_path']}
    aggregated_path={config['imerg_multiband']['aggregated_path']}
    geotiff_path={config['imerg_multiband']['geotiff_path']}
    ...
    COLUMNS:dict = config['imerg_multiband']['columns']
    BOUNDING_BOX:dict = config['bounding_box']
    SOURCE_PATH:str = config['imerg_multiband']['source_path']
    AGGREGATED_PATH:str = config['imerg_multiband']['aggregated_path']
    GEOTIFF_PATH:str = config['imerg_multiband']['geotiff_path']
